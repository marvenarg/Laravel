        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <button
                    ...
                    "
                    type="button"
                    class="me-4 inline-flex items-center justify-center w-12 h-10 rounded-full
                           bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200
                           hover:bg-gray-300 dark:hover:bg-gray-600 transition"
                    title="Cambiar tema"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 block dark:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12.79A9 9 0 1111.21 3c0 .34.02.67.05 1A7 7 0 0020 13c.33.03.66.05 1 .05z"/>
                    </svg>

                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden dark:block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m8-9h1M3 12H2m15.364 6.364l.707.707M5.929 5.929l-.707-.707m12.142 0l-.707.707M5.929 18.071l-.707.707M12 8a4 4 0 100 8 4 4 0 000-8z"/>
                    </svg>
                </button>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                <button
                    ...
                    "
                    type="button"
                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600"
                >
                    Cambiar tema
                </button>
